...
private[kafka010] class KafkaWriteTask(
  ...
  producerConfiguration.put("buffer.memory", new java.lang.Long(335544320L))
  ...
  def execute(iterator: Iterator[InternalRow]): Unit = {
    ...
    while (iterator.hasNext && failedWrite == null) {
      ...
      sendRow(currentRow, producer, Some(idx))
    }
    producer.send(new ProducerRecord[Array[Byte], Array[Byte]](topic.get.toString, idx, null, null))
  }
...
private[kafka010] abstract class KafkaRowWriter(
  ...
  protected def sendRow(
      row: InternalRow, producer: KafkaProducer[Array[Byte], Array[Byte]], partition: Option[Integer] = None): Unit = {
    ...
    val record = new ProducerRecord[Array[Byte], Array[Byte]](topic.toString, partition.orNull, key, value)
